...
- If I change this internal implementation, will client code break?
...
- Can I test this component without instantiating half my system?
...
- Can I add new functionality without editing existing code?
...
- Will this work on Linux, Windows, and Mac?
...
- What's the worst that could happen with bad input?
...
- Can I write a unit test for this without mocking 5 things?
