...
def demonstrate_portability():
    ...
    os.environ["INPUT_DIR"] = "/Users/michaelkao/My_Projects/Python/sample"
    os.environ["OUTPUT_DIR"] = "/Users/michaelkao/My_Projects/Python/sample"
    ...
    prod_processor.process_file("test.txt")
