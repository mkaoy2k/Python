...
if __name__ == "__main__":
    ...
    users = [
        ...
        {"email": "bob@example.com", "password": "bobspass456", "name": "Bob"},
        {"email": "charlie@example.com", "password": "charlie789", "name": "Charlie"}
    ]
